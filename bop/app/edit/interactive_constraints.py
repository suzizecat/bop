...
class AppConstraint(cmd2.CommandSet):
	...
	@cmd2.as_subcommand_to("constraint","add",addparser, help="Add a constraint")
	...
	@cmd2.as_subcommand_to("constraint", "list", _list_parser, help="List all products")
	...
	def print_level(self, constraint: Constraint, level=0):
		self._output_str += f'constraint add "{constraint.code}" -f'
	...
	@cmd2.as_subcommand_to("constraint", "rm", _rm_parser, help="Remove a constraint")
	...
	@cmd2.as_subcommand_to("constraint", "move", addparser, help="Edit a product")
